...
void setup() {
  ...
  Serial.println("Create the BLE Service");

  // Create the BLE Service
  BLEService *pService = pServer->createService(SERVICE_UUID);

  Serial.println("Create a BLE Characteristic 1");
  ...
  Serial.println("Create the BLE Characteristic 2");
  ...
  Serial.println("Start the service");
